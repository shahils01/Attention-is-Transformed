#!/usr/bin/env bash
#SBATCH --job-name=collab-h16-h200x2
...
torchrun --standalone --nproc_per_node=2 experiments/train_tinystories.py \
  ...
  --wandb_project lgma --wandb_run_name tinystory_collaborative_h16_gh200_ddp4_gb2048 --wandb_group tinystories \
  --wandb_tags tinystory,baseline,collaborative,h16,h200,ddp2,b256,ga4,gb2048 --wandb_mode online --wandb_dir "${OUTPUT_DIR}" \
  ...
  --weight_decay 0.01 --precision bf16 --attention collaborative --num_heads 16 --seed 0 \
