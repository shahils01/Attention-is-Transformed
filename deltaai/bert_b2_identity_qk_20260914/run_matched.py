...
RUN_NAME = 'bert_base_gt_mha_identity_qk_b2g8h12_random_seed42_explicit_20260914'
...
requested.update(num_base_heads=2, attention_type="gt_mha_identity", enforce_paper_gt_mha=False,
...
assert {k for k in requested if requested[k] != baseline['arguments'][k]} == {'attention_type', 'output_dir', 'run_name'}
