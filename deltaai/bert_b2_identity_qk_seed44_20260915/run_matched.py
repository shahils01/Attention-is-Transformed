...
RUN_NAME = 'bert_base_gt_mha_identity_qk_b2g8h12_random_seed44_explicit_20260915'
OUTPUT = Path('/work/hdd/bifg/arai3/lgma_runs') / RUN_NAME
reference = json.loads((STAGE / 'reference_manifest.json').read_text())['arguments']
requested = dict(reference)
requested.update(seed=44, num_base_heads=2, attention_type="gt_mha_identity", enforce_paper_gt_mha=False,
