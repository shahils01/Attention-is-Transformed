#!/usr/bin/env bash
# Run inside an arai3 DeltaAI interactive GH200 allocation.
set -euo pipefail

ROOT=/work/hdd/bifg/arai3/lgma_jobs/tinystories_multiseed_eval_20260924
