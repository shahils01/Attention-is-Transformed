#!/usr/bin/env bash
# Run inside an anayak2 DeltaAI interactive GH200 allocation.
set -euo pipefail

ROOT=/work/hdd/bicn/anayak2/lgma_jobs/tinystories_multiseed_eval_20260924
DATA=/work/hdd/bicn/anayak2/lgma_data/tinystories
